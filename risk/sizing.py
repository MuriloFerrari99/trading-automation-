...
def fixed_fractional_qty(
    ...
    *,
    ...
    qty = risk_$ / risk_per_share (floor a inteiro p/ acoes; preciso se fractional).
    Retorna 0 se o stop for invalido.
    """
...
def max_qty_for_exposure(
    ...
    *,
    ...
    max_total_qty = max_value / price
    if not fractional:
        max_total_qty = max_total_qty.to_integral_value(rounding=ROUND_DOWN)
